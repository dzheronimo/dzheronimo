...
### :dark_sunglasses: My best work :
 ...
 1. **Foodgram** - social network for sharing recipes\
    ***Stack***: Python 3, Django, Djange REST framework, Docker, Nginx, PostgreSQL, gunicorn, wsgi, git\
    <a href='https://github.com/dzheronimo/Foodgram'>Link to repository</a>\
    *About**: Social network on DRF and REACT. Post your recipes, share it with others, follow authors and cook it. Simple authorization via djoser&JWT.

 2. **YaMDB API** - art review service\
    ***Stack***: Python 3, Django, Django REST framework, pytest, Docker, gunicorn, NGINX, wsgi, git\
    <a  href='https://github.com/dzheronimo/YamDB-API'>Link to repository</a>\
 ...
 3. **YaTube** - Social network for publish diaries\
   ***Stack***: Python 3, Django 2.2, PostgreSQL, gunnicorn, NGINX\
   <a href='https://github.com/dzheronimo/YaTube'>Link to repository</a>\
 ...
 4. **REST API - YaTube** - RESTFull API for YaTube project\
    ***Stack***: Python 3, Django 2.2, Django REST framework, PostgreSQL, gunnicorn, NGINX.\
    <a  href='https://github.com/dzheronimo/YaTube-API'>Link to repository</a>\
